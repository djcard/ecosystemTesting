...
print.line(data.projects[projectName]);
        ...
        data.projects[projectName].sites[sitename]['uri'] = ask(
            ...
            defaultResponse = data.projects[projectName].sites[sitename].keyExists('uri') && data.projects[projectName].sites[
                sitename
            ].uri.len() ? data.projects[projectName].sites[sitename].uri : ''
        );

        data.projects[projectName].sites[sitename]['port'] = ask(
            message = 'what is the PORT of this site? : ',
            defaultResponse = data.projects[projectName].sites[sitename].keyExists('port') && data.projects[projectName].sites[
                sitename
